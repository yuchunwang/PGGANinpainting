...
if __name__ == '__main__':
    ...
    if 'celebA' in args.datasets:
        ...
        image_path =os.path.join("./data","celebA")
        data_files = os.path.join("./data", "celebA", "*.jpg")
        ...
        if not os.path.isdir(valid_path):
            ...
            for i in range(1, 20000):
                if i < 10:
                    shutil.move(image_path+'/'+'00000'+ str(i) +".jpg",valid_path+'/')
                elif  i<100:
                    shutil.move(image_path+'/'+'0000'+ str(i) +".jpg",valid_path+'/')
                elif i<1000:
                    shutil.move(image_path+'/'+'000'+ str(i) +".jpg",valid_path+'/')
                elif i<10000:
                    shutil.move(image_path+'/'+'00'+ str(i) +".jpg",valid_path+'/')
                elif i<100000:
                    shutil.move(image_path+'/'+'0'+ str(i) +".jpg",valid_path+'/')
                else:
                    shutil.move(image_path+'/'+ str(i) +".jpg",valid_path+'/')
        os.rename("celebA", "training")
